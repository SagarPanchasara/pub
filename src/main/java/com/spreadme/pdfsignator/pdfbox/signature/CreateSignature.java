 ...
 */
package com.spreadme.pdfsignator.pdfbox.signature;
...
public class CreateSignature extends CreateSignatureBase {
    ...
    public static void sign(String certificate, String password, String inputFile, String outputFile) throws GeneralSecurityException, IOException {
        sign(certificate, password, inputFile, outputFile, null, false);
    }

    public static void sign(String certificate, String _password, String inputFile, String outputFile, String tsaUrl, boolean externalSig) throws GeneralSecurityException, IOException {


        // load the keystore
        KeyStore keystore = KeyStore.getInstance("PKCS12");
        char[] password = _password.toCharArray(); // TODO use Java 6 java.io.Console.readPassword
