 ...
 */
package com.spreadme.pdfsignator.pdfbox.util;
...
/**
 *
 * This example demonstrates the use of the new methods {@link PDFMergerUtility#setDestinationDocumentInformation(PDDocumentInformation)
 * } and {@link PDFMergerUtility#setDestinationMetadata(PDMetadata)
